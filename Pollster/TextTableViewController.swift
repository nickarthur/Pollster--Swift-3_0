...
class TextTableViewController: UITableViewController, UITextViewDelegate
{
    ...
    func createTextViewFor(indexPath: IndexPath?) -> UITextView {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let textView = createTextViewFor(indexPath: indexPath)
    ...
    private lazy var sizingTextView: UITextView = self.createTextViewFor(indexPath: nil)
